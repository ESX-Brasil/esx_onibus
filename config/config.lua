Config = {}
Config.Locale = 'br' -- Suporte para idiomas br / en
Config.DebugLog = false

-- Opções de combustível: ajustam o combustível inicial para 100%, se você estiver usando o script de combustível associado. Certifique-se de definir outros para false.
